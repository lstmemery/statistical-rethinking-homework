...
second_test_deviance <- -2 * sum(dnorm(d2$height, mean=second_coefs[["a"]] + second_coefs[["b_1"]] * d2$age + second_coefs[["b_2"]] * d2$age^2, sd = first_coefs[["sigma"]], log = TRUE))
third_test_deviance <- -2 * sum(dnorm(d2$height, mean=third_coefs[["a"]] + third_coefs[["b_1"]] * d2$age + third_coefs[["b_2"]] * d2$age^2 + third_coefs[["b_3"]] * d2$age^3, sd = first_coefs[["sigma"]], log = TRUE))
fourth_test_deviance <- -2 * sum(dnorm(d2$height, mean=fourth_coefs[["a"]] + fourth_coefs[["b_1"]] * d2$age + fourth_coefs[["b_2"]] * d2$age^2 + fourth_coefs[["b_3"]] * d2$age^3 + fourth_coefs[["b_4"]] * d2$age^4, sd = first_coefs[["sigma"]], log = TRUE))
fifth_test_deviance <- -2 * sum(dnorm(d2$height, mean=fifth_coefs[["a"]] + fifth_coefs[["b_1"]] * d2$age + fifth_coefs[["b_2"]] * d2$age^2 + fifth_coefs[["b_3"]] * d2$age^3 + fifth_coefs[["b_4"]] * d2$age^4 + fifth_coefs[["b_5"]] * d2$age^5, sd = first_coefs[["sigma"]], log = TRUE))
sixth_test_deviance <- -2 * sum(dnorm(d2$height, mean=sixth_coefs[["a"]] + sixth_coefs[["b_1"]] * d2$age + sixth_coefs[["b_2"]] * d2$age^2 + sixth_coefs[["b_3"]] * d2$age^3 + sixth_coefs[["b_4"]] * d2$age^4 + sixth_coefs[["b_5"]] * d2$age^5 + sixth_coefs[["b_6"]] * d2$age^6, sd = first_coefs[["sigma"]], log = TRUE))

all_test_deviances <- c(first_test_deviance, second_test_deviance, third_test_deviance, fourth_test_deviance, fifth_test_deviance, sixth_test_deviance)
all_test_deviances
