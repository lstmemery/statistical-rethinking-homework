...
```{r}
compute_globe_grid_posterior <- function(water, total) {
...
```{r}
plot_globe_posterior(compute_globe_grid_posterior(3, 3))
```

```{r}
plot_globe_posterior(compute_globe_grid_posterior(3, 4))
```

```{r}
plot_globe_posterior(compute_globe_grid_posterior(5, 7))
```
